...
public class ProdController {
    ...
    public Result stoteList(ProdListForm params){
        PageInfo<ProdListVo> storeList= prodService.storeList(params);
    ...
    @ApiOperation("产品详细")
    @PostMapping("/prodDet")
    public Result prodDet(@RequestParam Long prodId){
...
//        List<ChildListVo> childList = prodService.childList(menuId);
