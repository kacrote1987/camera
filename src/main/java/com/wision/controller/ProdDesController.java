...
public class ProdDesController {
    ...
    public Result prodEdit(@RequestBody ProdDetForm params){
        prodDesService.prodEdit(params);
        return Result.success();
    }
    ...
    public Result tblList(@RequestParam Long prodId){
        List<TblListVo> tblList= prodDesService.tblList(prodId);
    ...
    public Result menuList(@RequestParam Long prodId){
        List<MenuListVo> menuList= prodDesService.menuList(prodId);
    ...
    public Result menuSave(@RequestBody MenuEditForm params){
        prodDesService.menuEdit(params);
        return Result.success();
    }
    ...
    public Result menuTree(@RequestParam Long prodId){
        List<MenuTreeVo> menuTree= prodDesService.menuTree(prodId);
