...
//                table03.addCell(new Paragraph("点位治理子系统、统一工作台、驾驶舱需求调研",font));
//                PdfPCell cell0302 = new PdfPCell(new Phrase("调研部门",font));//单元格
...
//                table03.addCell(new Paragraph("区大数据局、区公安分局",font));
//                document.add(table03);
//
//                PdfPTable table04 = new PdfPTable(4);
//                table04.addCell(new Paragraph("调研人员",font));
//                table04.addCell(new Paragraph("李淑华、赵新森、张纬良",font));
//                table04.addCell(new Paragraph("调研时间",font));
...
//                table05.addCell(new Paragraph("√系统开发前需求调研          □开发过程中需求变更调研\n" +
//                        "□上线实施过程中需求变更      □上线实施过程中新增需求调研",font));
...
//                table07.addCell(new Paragraph("1、了解平台建设目标：\n" +
